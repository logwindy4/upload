...
public class Application1 {
    ...
    * */
    ...
    public static void main(String[] args) {
        ...
        /* 점점 더 큰 자료형으로 데이터를 옮겨도 문제없이 자동 형변환 처리가 된다.*/
        byte bnum = 1;
        short snum = bnum;
        int inum = snum;
        long lnum = inum;
        ...
        long result1 = num1 + num2;  // int + long은 서로다른 자료형이라 데이터 손실이 발생하지 않는 int->long 변환을 자동 수행 후 연산한다.

        System.out.println("result1 : " + result1);

        /* 정수는 실수로 자동 형변환된다. */
//        long eight = 8888888888888888888;  // 이것도 자동으로 형변환이 일어난 상태이며 오류는 int범위를 벗어나서 에러발생
        long eight = 8;
        float four = eight;
